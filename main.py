	...
	try:
		...
		if event.type == VkBotEventType.MESSAGE_NEW:
			...
			if id != 2*10**9+6:
				...
				elif states[id] == '{"command":"keksik"}':
					msg(id, '@keksik.media (keksik.media) — интернет-издание об индустрии социальных сетей и IT-корпораций. \n\nКоманда keksik.media очень тесно сотрудничает с командой PTCodding. Сотрудничество основано на взаимном продвижении и обмене опытом, благодаря чему в плюсе остаются все &#128524;\n\nЧитайте keksik.media и будьте в курсе — vk.com/keksik.media &#128072;')
