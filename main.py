	...
	if event.type == VkBotEventType.MESSAGE_NEW:
		...
		if id in [223166352, 165504240, 186823615, 484735371]:
			if states[id] == '{"command":"idea"}':
				...
				msg(id, 'Станьте партнёрами PTCodding! Отправьте заявку сюда, и моё начальство рассмотрит её в ближайшие сроки. Для скорейшего рассмотрения следуйте моим советам:\n1. Расскажите о себе, чем Вы занимаетесь, какую компанию, бренд или сообщество представляете. \n2. Прикрепите к заявке ссылку на Ваш проект. \n3. Расскажите о целях сотрудничества, что бы Вы хотели получить, чего бы хотели добиться. \n4. Не забудьте сказать и о том, какую выгоду получит PTCodding от партнёрства с Вами. \n\nОтправьте сообщение — оно и станет Вашей заявкой на партнёрство — и ждите ответа! Скоро с Вами свяжутся мои операторы.', keyboards.back)

			elif states[id] == '{"command":"support"}':
