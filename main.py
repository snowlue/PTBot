	...
	for event in longpoll.listen():
		...
		if event.type == VkBotEventType.MESSAGE_NEW:
			...
			if id != 2000000002:
				...
				msg(id, 'У Вас есть возможность отправить Ваше местоположение сразу для заказа звукозаписи или ремонта ПК.', keyboards.locateboard())

			elif payload == '{"command":"sent_location"}':
				msg(id, 'Спасибо за отправку Вашего местоположения! Команда PTCodding обязательно учтёт это при оформлении заказа! &#128521;', keyboards.buy)
