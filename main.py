...
for event in longpoll.listen():
	...
	if event.type == VkBotEventType.MESSAGE_NEW:
		...
		if id in [223166352, 165504240, 186823615, 484735371, 229558144, 151081085]:
			if states[id] == '{"command":"idea"}':
				...
				msg(id, 'Ксено — творческий и в некоторых вопросах юридический мозг команды PTCodding, генератор идей. Присоединилась к команде 4 февраля 2018 года. Именно в её голове зародилась идея делать подкаст. Когда команда выясняла, с чего начать, Ксения предложила записывать еженедельный подкаст, в котором озвучиваются новости ушедшей недели — подкаст «Взгляд в неделю». Принимала участие в записи бонусного выпуска 1 июня.')
