        ...
        if event.type == VkBotEventType.MESSAGE_NEW:
            ...
            if id != 2*10**9+6:
                if states[id] == '{"command":"partnership"}':
                    ...
                    msg(id, 'Я очень хочу кушать. Я голодный... &#128546; Дайте, пожалуйста, пару долларов, чтобы мне купили пончик &#127849; \nЕсли хотите поддержать наш проект, то лучше сделайте пожертвование через приложение — так Вы не просто поддержите нас, но и продвинете проект! &#128200;', keyboards.donateboard('action=transfer-to-group&group_id=132868814&aid=10'))
