	...
	if event.type == VkBotEventType.MESSAGE_NEW:
		...
		if id != 2000000002 and id in [223166352, 165504240, 186823615, 484735371]:
			if payload == '{"command":"idea"}':
				...
				msg(id, 'Если хотите поддержать наш проект, то лучше сделайте пожертвование через приложение — так Вы не просто поддержите нас, но и продвинете проект! &#128200;', keyboard.appboard(6887721, -132868814, 'Пончик — наши донаты &#127849;'))
